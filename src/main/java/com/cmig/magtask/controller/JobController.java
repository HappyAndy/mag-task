package com.cmig.magtask.controller;
...
import com.cmig.magtask.job.BaseJob;
...
public class JobController {
	...
	public void addjob(
		...
		addJob(description ,jobClassName, jobGroupName, cronExpression);
	}
	
	public  void addJob(String description ,String jobClassName, String jobGroupName, String cronExpression)throws Exception{
...
//			Scheduler scheduler = schedulerFactory.getScheduler();
			Scheduler scheduler = schedulerFactoryBean.getScheduler(); //sf.getScheduler();
